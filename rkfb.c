...
rkfb_fb_info_init(struct rkfb_softc *sc)
{
        ...
        info->fb_bpp = sc->bpp;
        /*
         * The framebuffer is allocated with BUS_DMA_COHERENT, so expose the
         * same uncached attribute through the fb/vt mmap path to avoid
         * ttydev/vt advertising a conflicting default cache mode.
         */

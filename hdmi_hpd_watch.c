...
int main(void) {
    ...
    hdmi[0x4001]=0x00; hdmi[0x4002]=0xff;
    hdmi[0x3000]=0xe2; /* PDZ+ENTMDS+SPARECTRL */
    usleep(5000);
    hdmi[0x4005]=0x01; /* release PHY reset */
    usleep(5000);

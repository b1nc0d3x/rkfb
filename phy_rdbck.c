...
int main(void) {
    ...
    hdmi[(0x4001)*4] = 0x00;
    hdmi[(0x4002)*4] = 0xff;
    hdmi[(0x3029)*4] = 0x17;  /* I2C divider */
    hdmi[(0x3000)*4] = 0xe2;  /* PHY powered up so MPLL is active */
    usleep(5000);
    ...
    hdmi[(0x3020)*4] = 0x69;  /* slave */
    hdmi[(0x3021)*4] = 0x06;  /* reg addr */
    hdmi[(0x3026)*4] = 0x40;  /* trigger READ (bit6=1) */
    for (int i=0; i<50; i++) {
        usleep(500);
    ...
    for (int i=0; i<50; i++) {
        ...
        if (st & 0x08) { hdmi[(0x3027)*4]=0x08; break; }
    }
